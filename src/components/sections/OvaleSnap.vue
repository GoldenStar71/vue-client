      ...
      <svg id="drawOvalesnap" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" version="1.1"
        ...
        <g transform="translate(290 300) scale(0.6 0.6)">
          ...
          <path id="S2"
            ...
            class="ovale-snap-point" bet_list="CH8 CH43 CH16 CH52 CH30 CH36"></path>
          <path id="OR" d="M666 92.5H876L1016 197.5H666V92.5Z " class="ovale-snap-point"
            bet_list="PL1 CH9 CH17 CH20 CH34"></path>
          ...
          <path id="VI"
            ...
            class="ovale-snap-point" bet_list="CH3 CH15 PL26 CH35"></path>
          ...
          <path id="o5"
            ...
            class="ovale-snap-point" bet_list="o23 o10 o5 o24 o16 PL23 PL10 PL5 PL24 PL16"></path>
          <path id="o10"
            ...
            class="ovale-snap-point" bet_list="o8 o23 o10 o5 o24 PL8 PL23 PL10 PL5 PL24"></path>
          <path id="o23"
            ...
            class="ovale-snap-point" bet_list="o30 o8 o23 o10 o5 PL30 PL8 PL23 PL10 PL5"></path>
          <path id="o8"
            ...
            class="ovale-snap-point" bet_list="o11 o30 o8 o23 o10 PL11 PL30 PL8 PL23 PL10"></path>
          <path id="o3"
            ...
            class="ovale-snap-point" bet_list="o12 o35 o3 o26 o0 PL12 PL35 PL3 PL26 PL0"></path>
          <path id="o26"
            ...
            class="ovale-snap-point" bet_list="o35 o3 o26 o0 o32 PL35 PL3 PL26 PL0 PL32"></path>
          <path id="o0"
